...
#   @unittest.skip("delete this line to run the test")
  ...
  def test_volume_of_cube(self):
    #add test code here
    volume_cube = length_of_cube(15)
    self.assertEqual( 3375, volume_cube )
...
#   @unittest.skip("delete this line to run the test")
  def test_reverse_string(self):
    #add test code here
    reversed_string = normal_string("This is a string")
    # reversed_string = string(reversed("This is a string"))
...
#   @unittest.skip("delete this line to run the test")
  def test_fahrenheit_to_celsius(self):
    #add test code here
    celsius = fahrenheit(78)
    self.assertEqual( 25, celsius)
